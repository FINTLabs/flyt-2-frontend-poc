...
import {
    ...
    dataSourceNode, acosUploadFile, acosDocToDocDesc, operationEditText,
} from '~/mockData/nodes';
                ...
                <Accordion size="small" indent={false}>
                    ...
                    <Accordion.Item>
                        ...
                        <Accordion.Content>
                            <VStack gap={'2'}>
                                <BaseNode
                                    label={'Fylkesråd: Last opp fil'}
                                    node={acosUploadFile}
                                />
                                <BaseNode label={"ACOS dok. til dok.beskrivelser"} node={acosDocToDocDesc}/>
                            </VStack>
                        </Accordion.Content>
                    </Accordion.Item>
                    <Accordion.Item>
